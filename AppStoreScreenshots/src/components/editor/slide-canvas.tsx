  ...
  return (
    <div style={{ textAlign: align, position: "relative", width: "100%" }}>
      <EditableText
        ...
        placeholder="LABEL"
        style={{
          fontSize: slide.labelFontSize ?? unit * 0.028,
          fontWeight: 600,
          letterSpacing: unit * 0.0015,
          color: slide.labelColor ?? accent,
      ...
      <EditableText
        ...
        style={{
          fontSize: slide.headlineFontSize ?? unit * 0.092,
          fontWeight: 700,
          lineHeight: 0.96,
          letterSpacing: -unit * 0.001,
          color: slide.headlineColor ?? fg,
        }}
      />
    </div>
  );
      ...
      <div style={{ display: "flex", alignItems: "center", gap: cW * 0.03, zIndex: 2 }}>
        ...
        <div>
          ...
          <EditableText
            ...
            onChange={edit?.onHeadlineChange}
            style={{
              fontSize: slide.headlineFontSize ?? cW * 0.028,
              color: slide.headlineColor ?? "rgba(255,255,255,0.85)",
              marginTop: cW * 0.012,
              lineHeight: 1.25,
            }}
          />
