...
function migrateSlide(slide: Slide): Slide {
  ...
  return {
    ...
    labelFontSize:
      typeof slide.labelFontSize === "number" &&
      Number.isFinite(slide.labelFontSize) &&
      slide.labelFontSize >= 12
        ? slide.labelFontSize
        : undefined,
    headlineFontSize:
      typeof slide.headlineFontSize === "number" &&
      Number.isFinite(slide.headlineFontSize) &&
      slide.headlineFontSize >= 24
        ? slide.headlineFontSize
        : undefined,
    labelColor: typeof slide.labelColor === "string" ? slide.labelColor : undefined,
    headlineColor: typeof slide.headlineColor === "string" ? slide.headlineColor : undefined,
